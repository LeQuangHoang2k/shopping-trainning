...
import "./AccountSidebarSvg.css";

export const Information = (props) => {
  return (
    <svg
      className="account_sidebar_svg"
      stroke="currentColor"
      fill="currentColor"
      stroke-width="0"
      viewBox="0 0 24 24"
...
export const ReviewOrders = (props) => {
  return <div></div>;
};
...
export const CoinManagement = (props) => {
  return <div></div>;
};

export const BookCare = (props) => {
  return <div></div>;
};
